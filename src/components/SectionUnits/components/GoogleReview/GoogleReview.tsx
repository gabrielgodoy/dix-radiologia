        ...
        <div className={style.headerInfoContainer}>
          ...
          >
            ...
            >
              ...
              >
                <div
                  className={`${style.ratingItemFilled} es-rating-item es-rating-stars-item-filled`}
                >
                  <div
                    className={`${style.ratingItemUnfilled} es-rating-item-unfilled`}
                  >
                    <svg
                      viewBox="0 0 14 14"
                      fill="none"
                  ...
                  <div className={`${style.ratingItemFilled}`}>
                    <svg
                      viewBox="0 0 14 14"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                  className={`${style.ratingItemFilled} es-rating-item es-rating-stars-item-unfilled`}
                >
                  <div
                    className={`${style.ratingItemUnfilled} es-rating-item-unfilled`}
                  >
                  ...
                  <div
                    className={`${style.ratingItemFilled} ${style.ratingPartiallyFilled}`}
                    style={{
                      clipPath: `inset(0px ${lastStarProgress}% 0px 0px)`,
                    }}
                  >
                    <svg
                      viewBox="0 0 14 14"
